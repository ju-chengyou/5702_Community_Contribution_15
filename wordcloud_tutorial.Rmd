...
In order to get the best viewing experience, please install the package through `library(devtools)` and 
`devtools::install_github("lchiffon/wordcloud2")` in the cosole. Also notice some chunks of code may need to be run multiple times.
